...
const options = {
    definition: {
        ...
        info: {
            ...
            description:
                'API para gerenciamento de um Departamento de Polícia, gerenciando agentes e casos. Esta API segue o padrão REST e a arquitetura MVC, utilizando arrays para armazenamento temporário de dados.',
        },
        servers: [
            {
